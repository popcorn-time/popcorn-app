 ...
 * numeral.js language configuration                                                                                     
 * language : greek Greece (gr)                                                                                         
*/                                                                                                                      
function(){var a={delimiters:{thousands:".",decimal:","},abbreviations:{thousand:"xil",million:"ek",billion:"δις",trillion:"τρις"},ordinal:function(){return"º"},currency:{symbol:"€"}};"undefined"!=typeof module&&module.exports&&(module.exports=a),"undefined"!=typeof window&&this.numeral&&this.numeral.language&&this.numeral.language("gr",a)}(),/*! 
 * numeral.js language configuration
 * language : thai (th)
